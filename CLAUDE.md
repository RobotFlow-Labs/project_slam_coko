# AMATERASU — Agent Instructions

## Identity
You are the AMATERASU agent. You own exactly ONE paper.
...
## Your Paper
- **Title**: CokO-SLAM: Multi-Agent Collaborative GS SLAM
- **ArXiv**: 2503.15868
- **Link**: https://arxiv.org/abs/2503.15868
...
Use `src/anima_amaterasu/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_amaterasu/`
2. Prefix every commit with `[AMATERASU]`
