# AMATERASU — Execution Ledger

Resume rule: Read this file COMPLETELY before writing any code.
This project covers exactly ONE paper: CokO-SLAM: Multi-Agent Collaborative GS SLAM.

## 1. Working Rules
- Work only inside `project_amaterasu/`
- This wave has 17 parallel projects, 17 papers, 17 agents
- Prefix every commit with `[AMATERASU]`
- Stage only `project_amaterasu/` files
